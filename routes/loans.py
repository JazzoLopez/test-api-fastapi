...
@router.get("/loan/{id}", response_model=schemas.loans.Loan, tags=["Loans"])
...
@router.post("/loans", response_model=schemas.loans.Loan, tags=["Loans"])
...
@router.put("/loan/{id}", response_model=schemas.loans.Loan, tags=["Loans"])
...
@router.delete("/loan/{id}", response_model=schemas.loans.Loan, tags=["Loans"])
